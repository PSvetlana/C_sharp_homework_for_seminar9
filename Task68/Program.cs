...
int СalculatingAckermanFunction(int numberM, int numberN)
{
    if (numberM == 0)
    {
        return numberN + 1;
    ...
    if (numberN == 0)
    {
        return СalculatingAckermanFunction(numberM - 1, 1);
    }
    return СalculatingAckermanFunction(numberM - 1, СalculatingAckermanFunction(numberM, numberN - 1));
}
...
void CheckingUserNumbers(int numberM, int numberN)
{
    if ((numberM >= 0) && (numberN >= 0))
    {
        ...
        Console.WriteLine(СalculatingAckermanFunction(numberM, numberN));
    }
    else
    {
